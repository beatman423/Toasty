#
#  Be sure to run `pod spec lint Toasty.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Beatman" => "beatman_z@163.com" }
  # Or just: spec.author    = "Beatman"
  # spec.authors            = { "Beatman" => "beatman_z@163.com" }
  # spec.social_media_url   = "https://twitter.com/Beatman"
  ...
  spec.source       = { :git => "https://github.com/beatman423/Toasty.git", :tag => "#{spec.version}" }
